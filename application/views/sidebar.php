<div class="left_content">
    ...
    <div class="sidebar_search">
        <form>
            ...
            <input type="image" class="search_submit" src="<?php echo base_url(); ?>public/images/search.png" />
        </form>            
    </div>
    ...
    <div class="sidebar_box">
        ...
        <div class="sidebar_box_content">
            ...
            <img src="<?php echo base_url(); ?>public/images/info.png" alt="" title="" class="sidebar_icon_right" />
            <p>
    ...
    <div class="sidebar_box">
        ...
        <div class="sidebar_box_content">
            ...
            <img src="<?php echo base_url(); ?>public/images/notice.png" alt="" title="" class="sidebar_icon_right" />
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>                
        </div>
    ...
    <div class="sidebar_box">
        ...
        <div class="sidebar_box_content">
            ...
            <img src="<?php echo base_url(); ?>public/images/photo.png" alt="" title="" class="sidebar_icon_right" />
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
            </p>                
        </div>
